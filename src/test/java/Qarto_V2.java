...
//        Thread.sleep(2000);
    ...
    public static void Global_Search() throws InterruptedException, AWTException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.xpath("//a[contains(text(),'What are some of the dark lessons that life showed you")).click();
        Thread.sleep(3000);
        //Explore_Categories
...
//        Thread.sleep(2000);
    ...
    public static void Categories_Sort_By() throws InterruptedException, AWTException {
        ...
        driver.findElement(By.xpath("//div[@class='ng-input']")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("//span[@class='ng-option-label'][contains(text(),'Most Viewed')]")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("//div[@class='ng-input']")).click();
        Thread.sleep(2000);
        ...
        driver.findElement(By.xpath("//div[@class='ng-input']")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("//span[contains(text(),'A-Z')]")).click();
        Thread.sleep(2000);
    }
