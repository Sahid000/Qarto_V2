...
//        Thread.sleep(3000);
    ...
    public static void Task_Notifications() throws InterruptedException, AWTException{
        ...
        Thread.sleep(2000);
        //See_All
        driver.findElement(By.xpath("//header/nav[1]/div[2]/ul[1]/li[6]/ul[1]/li[3]/a[1]/h3[1]")).click();
        Thread.sleep(10000);
    }
    ...
    public static void General_Notifications() throws InterruptedException, AWTException {
        ...
        Thread.sleep(2000);
        //See_All
        driver.findElement(By.xpath("//header/nav[1]/div[2]/ul[1]/li[8]/ul[1]/li[5]/a[1]/h3[1]")).click();
        Thread.sleep(10000);
        //Explore_Category
